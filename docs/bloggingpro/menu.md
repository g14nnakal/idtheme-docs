---
title: Cara Mengatur Menu di Theme Bloggingpro
outline: deep
---

# Mengatur Menu Bloggingpro

## Video Tutorial

<YouTubeEmbed video-id="T4B8t4-O1VE" />
...
- **Footer Menu:** navigasi di footer.
...
Note: Untuk theme bloggingpro support sampai 4 lokasi menu, silahkan lihat tutorial video diatas.
