---
title: AMP Settings in the Galepro Theme
outline: deep
---

# AMP Settings in the Galepro Theme
...
1. Open **Settings → Galepro Core**, then go to the AMP (New) menu. There you can configure ads that will appear on your AMP pages. See the image:
