---
title: AMP Settings in the Majalahpro Theme
outline: deep
---

# AMP Settings in the Majalahpro Theme

The Majalahpro theme supports AMP via the official WordPress AMP plugin, with template adjustments in the theme so AMP views match the normal layout.
...
1. Open **Settings → Majalahpro Core**, then go to the AMP (New) menu. There you can configure ads that will appear on your AMP pages. See the image:

![AMP Ads settings in the Majalahpro Core Plugin](/general/amp/amp-plugin-core-majalahpro.jpg)
