---
title: AMP Settings in the Wpberita Theme
outline: deep
---

# AMP Settings in the Wpberita Theme
...
1. Go to the Customizer, then open the AMP (New) menu. There you can configure ads for your AMP pages. See the screenshot:

![AMP Ads Settings in the Customizer](/general/amp/amp-customizer-wpberita.jpg)
...
*AMP does not support JavaScript. If you insert JavaScript in posts, it will not work. Disable the AMP plugin if you need JavaScript in posts.*
