---
title: How to Post in the Wpberita Theme
outline: deep
---

# How to Post in the Wpberita Theme

Wpberita is designed for text‑based news/articles.
...
The Wpberita theme will display the images as a gallery according to the configured layout.
...
The Wpberita theme provides a **Focus News** feature to highlight specific news with a different layout on index and archive pages.
