---
title: Setting AMP pada Theme Galepro
outline: deep
---

# Pengaturan AMP pada Theme Galepro
...
1. Silahkan anda masuk ke **Settings -> Galepro Core**, setelah itu anda masuk ke menu AMP (New), nah disana anda bisa mengatur iklan yang akan muncul halaman amp anda. Silahkan lihat gambar berikut:

![Pengaturan AMP Ads di Plugin Core](/general/amp/amp-plugin-core.jpg)
