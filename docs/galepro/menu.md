---
title: Cara Mengatur Menu di Theme Galepro
outline: deep
---

# Pengaturan Menu Galepro

## Video Tutorial

Dokumentasi asli menyertakan video, sebaiknya anda lihat videonya terlebih dahulu untuk mengikuti langkah dengan lebih jelas.

<YouTubeEmbed video-id="nVvnInfmNJc" />

## Membuat Menu
- Buka **Appearance > Menus > create a new menu**.
- Beri nama, klik Create Menu.
- Tambahkan item dari Pages/Posts/Custom Links/Categories, klik Add to Menu.
- Susun urutan, buat dropdown dengan drag & drop.

## Lokasi Menu
- **Primary:** menu utama di header.
- **Secondary:** menu kedua di footer.
...
Note: Untuk theme Galepro support sampai 2 lokasi menu, silahkan lihat tutorial video diatas.
...
- Belum mendukung footer menu, untuk footer menu silahkan gunakan widget menu pada footer.
