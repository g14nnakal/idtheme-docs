---
title: Setting AMP pada Theme Jurnalpress
outline: deep
---

# Setting AMP pada Theme Jurnalpress
...
1. Silahkan anda masuk ke **Customizer -> Banner**, setelah itu anda masuk ke tiap section, buka banner type HTML maka ada opsi tambahan berupa **HTML code (AMP version)**. Nah disana anda bisa mengatur iklan yang akan muncul halaman amp anda. Silahkan lihat gambar berikut:

![Pengaturan AMP Ads di Customizer](/general/amp/amp-html-banner-type-jurnalpress.png)

2. Jika anda menggunakan page level ads, silahkan anda masuk ke **Customizer -> Other -> Head Script**, ada tambahan pengaturan berupa **HTML code (AMP version)**. Nah disana anda bisa mengatur head script khusus laman amp.

3. Untuk mempelajari iklan apa saja yang support dan format iklannya, silahkan anda kunjungi halaman berikut untuk mempelajarinya:
