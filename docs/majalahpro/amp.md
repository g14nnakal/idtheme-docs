---
title: Setting AMP pada Theme Majalahpro
outline: deep
---

# Pengaturan AMP di Majalahpro

Theme Majalahpro mendukung AMP melalui plugin AMP resmi WordPress, dengan penyesuaian template di theme agar tampilan AMP serasi dengan tampilan normal.
...
1. Silahkan anda masuk ke **Settings -> Majalahpro Core**, setelah itu anda masuk ke menu AMP (New), nah disana anda bisa mengatur iklan yang akan muncul halaman amp anda. Silahkan lihat gambar berikut:

![Pengaturan AMP Ads di Plugin Majalahpro Core](/general/amp/amp-plugin-core-majalahpro.jpg)
