---
title: Newkarma v1.1.3 dan Fitur Baru AMP
outline: deep
---

# Newkarma v1.1.3 dan Fitur Baru AMP

Pada versi **Newkarma v1.1.3**, dukungan AMP ditingkatkan dengan menggunakan **template AMP khusus** di theme, bukan lagi template bawaan plugin AMP.

## Perbedaan Implementasi AMP

Sebelumnya:

- Newkarma sudah mendukung AMP melalui template bawaan plugin AMP.
- Jika menggunakan mode **Transitional**, tampilan AMP dan template Newkarma kurang sinkron.
- Menu mobile bisa tidak bekerja karena AMP tidak mengizinkan JavaScript biasa.

Pada versi 1.1.3:

- Menggunakan **template AMP khusus Newkarma**.
- Tidak hanya single post, tetapi semua halaman yang menggunakan URL `?amp` sudah didukung:
...
1. Silahkan anda masuk ke **Settings -> Newkarma Core**, setelah itu anda masuk ke menu AMP (New), nah disana anda bisa mengatur iklan yang akan muncul halaman amp anda. Silahkan lihat gambar berikut:

![Pengaturan AMP Ads di Plugin Newkarma Core](/general/amp/amp-plugin-core-newkarma.jpg)
