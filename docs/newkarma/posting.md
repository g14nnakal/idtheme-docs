---
title: Cara Posting di Theme Newkarma
outline: deep
---

# Cara Posting di Theme Newkarma

Theme Newkarma mendukung beberapa format posting: **standard**, **video**, dan **gallery**.  
Ini memudahkan anda menampilkan konten berita, video, dan galeri gambar.

## Video Tutorial

Pada dokumentasi asli, tersedia video yang menjelaskan langkah-langkah posting.  
Anda dapat menambahkan ID video anda di bawah ini.
...
Theme Newkarma akan menampilkan gambar-gambar tersebut sebagai galeri sesuai layout yang sudah diatur.
...
Theme Newkarma menyediakan fitur **Focus News** untuk menonjolkan berita tertentu dengan layout berbeda pada halaman index dan archive.
