---
title: Cara Mengatur Menu di Theme Vidpro
outline: deep
---

# Cara Mengatur Menu di Theme Vidpro

Theme Vidpro menggunakan sistem menu bawaan WordPress.  
...
- **Secondary:** (Support 1 level menu), menu pada icon grid paling kanan di header.
...
Note: Untuk theme Vidpro support sampai 5 lokasi menu, silahkan lihat tutorial video diatas.
